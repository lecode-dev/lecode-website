        ...
        <div className="space-y-12">
          <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
            ...
            <p className="text-xl text-gray-300">
              Knows the better that our team can offer!
              <br /> On lecode we have advanced software, advanced research for
              advanced people.
            </p>
          </div>
          <ul className="space-y-4 sm:grid sm:grid-cols-2 sm:gap-6 sm:space-y-0 lg:grid-cols-3 lg:gap-8">
            {empoloyers.map((person) => (
              <li
                key={person.name}
                className="py-10 px-6 bg-gray-darkest text-center rounded-lg xl:px-10 xl:text-left"
              >
